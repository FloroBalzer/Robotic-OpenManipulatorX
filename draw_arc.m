function draw_arc(start_pos,end_pos,center_pos, num_points, port_num, protocol_version)
%% setting up constants
draw_height = 6.2;
start = [start_pos, draw_height, 1/sqrt(2)];
endp = [end_pos, draw_height, 1/sqrt(2)];
center = [center_pos, draw_height, 1/sqrt(2)];
[trajectory1] = circletasktrajectory(start,endp,center,num_points);
